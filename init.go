...
func init() {
	...
	globals.GuestAccount = nex.NewAccount(nex_types.NewPID(100), "guest", "MMQea3n!fsik", false) // * Guest account password is always the same, known to all consoles. Only allow on the friends server
